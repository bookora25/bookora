                    ...
                    req.status === "pending"
                        ? `
                            <button class="req-btn req-approve"
                                onclick="approveRequest(${req.bookID}, '${req.from}')">
                                Approve
                            </button>

                            <button class="req-btn req-decline"
                                onclick="declineRequest(${req.bookID}, '${req.from}')">
                                Decline
                            </button>
                          `
                        : ""
                ...
                ${
                    req.status === "approved"
                        ? `
                            ...
                            <p><strong>Buyer Email:</strong> ${req.email || "Not provided"}</p>
                            <p><strong>Buyer Phone:</strong> ${req.phone || "Not provided"}</p>
                          `
                        : ""
                }
